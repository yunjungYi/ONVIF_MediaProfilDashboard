...
namespace ONVIF_MediaProfilDashboard.Media {
    ...
    public interface Media2 {
        ...
        // CODEGEN: 매개 변수 모드를 사용하여 캡처할 수 없는 추가 스키마 정보가 'Configuration' 매개 변수에 필요합니다. 특정 특성은 'System.Xml.Serialization.XmlElementAttribute'입니다.
        ...
        // CODEGEN: 매개 변수 모드를 사용하여 캡처할 수 없는 추가 스키마 정보가 'Options' 매개 변수에 필요합니다. 특정 특성은 'System.Xml.Serialization.XmlElementAttribute'입니다.
        ...
        // CODEGEN: 매개 변수 모드를 사용하여 캡처할 수 없는 추가 스키마 정보가 'Uri' 매개 변수에 필요합니다. 특정 특성은 'System.Xml.Serialization.XmlElementAttribute'입니다.
        ...
        // CODEGEN: 매개 변수 모드를 사용하여 캡처할 수 없는 추가 스키마 정보가 'Masks' 매개 변수에 필요합니다. 특정 특성은 'System.Xml.Serialization.XmlElementAttribute'입니다.
